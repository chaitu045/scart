<?php
/**
 * This file deals with the white labeling of Interspire Shopping Cart.
 */
 ...
 */
$GLOBALS['ISC_CFG']['ProductName'] = 'Interspire Shopping Cart';
 ...
 */
$GLOBALS['ISC_CFG']['ControlPanelTitle'] = "Interspire Shopping Cart Control Panel (%%EDITION%% Edition)";
 ...
 */
$GLOBALS['ISC_CFG']['AdminCopyright'] = 'Powered by Interspire Shopping Cart %%VERSION%% &copy; 2004-'.date('Y').' Interspire Pty. Ltd.';
 ...
 */
$GLOBALS['ISC_CFG']['SearchKnowledgeBaseUrl'] = 'http://anonym.to/?http://www.viewkb.com/search.php?searchOverride=86&tplHeader='.rawurlencode(GetConfig('ProductName')).'&q=%query%';
...
$GLOBALS['ISC_CFG']['AddonXMLFile'] = 'http://anonym.to/?http://www.interspire.com/shoppingcart/_addonlist.php';

/**
 * The file which validates addon license keys
 */

$GLOBALS['ISC_CFG']["AddonLicenseURL"] = "http://anonym.to/?http://www.interspire.com/shoppingcart/_addonlicencecheck.php";

/**
 * The file which streams the addons zip file back
 */

$GLOBALS['ISC_CFG']["AddonStreamURL"] = "http://anonym.to/?http://www.interspire.com/shoppingcart/_addonstream.php";
 ...
 */
$GLOBALS['ISC_CFG']['SystemInfoEditionUpgradeLink'] = "http://anonym.to/?http://www.interspire.com/shoppingcart/";
...
$GLOBALS['ISC_CFG']['BuiltInGateway'] = 'paypal';
