...
<head>
	...
	<script type="text/javascript">
		var url = 'remote.php';
		var critical_errors = "{{ CriticalErrors|raw }}";
	</script>
...
<body>
	...
	<div id="box">
			...
			<td>
				<table>
					...
					<tr>
						...
						<td><input type="text" name="ShopPath" id="ShopPath" class="Field250" value="{{ ShopPath|raw }}"> <img onmouseout="HideHelp('shoppathhelp');" onmouseover="ShowHelp('shoppathhelp', '{% lang 'ShopPath' %}', '{% lang 'ShopPathHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
					...
					<tr>
						...
						<td><input type="text" name="StoreCurrencyCode" id="StoreCurrencyCode" maxlength="3" class="Field50" value="{{ StoreCurrencyCode|raw }}"> <img onmouseout="HideHelp('storecurrencycodehelp');" onmouseover="ShowHelp('storecurrencycodehelp', '{% lang 'StoreCurrencyCode' %}', '{% lang 'StoreCurrencyCodeHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
						<div style="display:none" id="storecurrencycodehelp"></div></td>
					</tr>
					<tr>
						<td nowrap style="padding:0px 10px 0px 10px">&nbsp;</td>
						<td>
							<label><input type="checkbox" name="installSampleData" id="installSampleData" value="1" {{ InstallSampleData|raw }} /> {% lang 'InstallSampleData' %}</label>
					...
					<tr>
						...
						<td><input type="text" name="UserEmail" id="UserEmail" class="Field150" value="{{ UserEmail|raw }}"> <img onmouseout="HideHelp('useremailhelp');" onmouseover="ShowHelp('useremailhelp', '{% lang 'EmailAddress' %}', '{% lang 'InstallEmailAddressHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
					...
					<tr>
						...
						<td>
							<input type="password" autocomplete="off" name="UserPass" id="UserPass" class="Field150" value="{{ UserPass|raw }}">
					...
					<tr>
						...
						<td><input type="password" autocomplete="off" name="UserPass1" id="UserPass1" class="Field150" value="{{ UserPass|raw }}"> <img onmouseout="HideHelp('userpass1help');" onmouseover="ShowHelp('userpass1help', '{% lang 'ConfirmYourPassword' %}', '{% lang 'ConfirmYourPasswordHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
				...
				<table class="DBDetails" style="padding:10px 10px 10px 20px">
					<tr class="DBDetails">
						...
						<td><input type="text" name="dbUser" id="dbUser" class="Field150" value="{{ dbUser|raw }}"> <img onmouseout="HideHelp('dbuserhelp');" onmouseover="ShowHelp('dbuserhelp', '{% lang 'DatabaseUser' %}', '{% lang 'DatabaseUserHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
						<div style="display:none" id="dbuserhelp"></div></td>
					</tr>
					<tr class="DBDetails">
						<td nowrap style="padding:0px 10px 0px 10px">&nbsp;&nbsp; {% lang 'DatabasePassword' %}:</td>
						<td><input type="password" autocomplete="off" name="dbPass" id="dbPass" class="Field150" value="{{ dbPass|raw }}"> <img onmouseout="HideHelp('dbpasshelp');" onmouseover="ShowHelp('dbpasshelp', '{% lang 'DatabasePassword' %}', '{% lang 'DatabasePasswordHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
					...
					<tr class="DBDetails">
						...
						<td><input type="text" name="dbServer" id="dbServer" class="Field150" value="{{ dbServer|raw }}"> <img onmouseout="HideHelp('dbhostnamehelp');" onmouseover="ShowHelp('dbhostnamehelp', '{% lang 'DatabaseHostname' %}', '{% lang 'DatabaseHostnameHelp' %}')" src="images/help.gif" width="24" height="16" border="0"><div style="display:none" id="dbhostnamehelp"></div></td>
					</tr>
					<tr class="DBDetails">
						<td nowrap style="padding:0px 10px 0px 10px"><span class="Required">*</span> {% lang 'DatabaseName' %}:</td>
						<td><input type="text" name="dbDatabase" id="dbDatabase" class="Field150" value="{{ dbDatabase|raw }}"> <img onmouseout="HideHelp('dbnamehelp');" onmouseover="ShowHelp('dbnamehelp', '{% lang 'DatabaseName' %}', '{% lang 'DatabaseNameHelp' %}')" src="images/help.gif" width="24" height="16" border="0"><div style="display:none" id="dbnamehelp"></div></td>
					</tr>
					<tr class="DBDetails">
						<td nowrap style="padding:0px 10px 0px 10px">&nbsp;&nbsp; {% lang 'DatabaseTablePrefix' %}:</td>
						<td><input type="text" name="tablePrefix" id="tablePrefix" class="Field150" value="{{ tablePrefix|raw }}"> <img onmouseout="HideHelp('dbprefixhelp');" onmouseover="ShowHelp('dbprefixhelp', '{% lang 'DatabaseTablePrefix' %}', '{% lang 'DatabaseTablePrefixHelp' %}')" src="images/help.gif" width="24" height="16" border="0"><div style="display:none" id="dbprefixhelp"></div></td>
					</tr>
				</table>
				<table>
					<tr>
		...
		<div style="padding:10px; margin-bottom:20px; text-align:center" class="PageFooter">
			...
			Powered by Interspire Shopping Cart {{ ProductVersion|raw }} &copy; 2004-{{ Year|raw }} Interspire Pty. Ltd.
		</div>
	</div>
	</form>

	<div id="permissionsBox" style="display:none">
		<div style="background-image:url('images/permissions_error.gif'); background-position:right bottom; background-repeat:no-repeat; height:100%">{{ PermissionErrors|raw }}</div>
	</div>

	<script type="text/javascript">{{ AutoJS|raw }}</script>
